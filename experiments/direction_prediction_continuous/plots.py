...
def main():
    ...
    plot(proposed[1], baseline[1], 50, '$\sigma(\gamma)$', "results/direction_gamma_continuous.pdf")
    plot(proposed[2], baseline[2], 50, 'Accuracy', "results/direction_acc_continuous.pdf")
