...
def main():
    ...
    plot(proposed[1], baseline[1], len(baseline[0]), '$\sigma(\gamma)$', "results/direction_gamma_N=100.pdf")
    plot(proposed[2], baseline[2], 150, 'Accuracy', "results/direction_acc_N=100.pdf")
