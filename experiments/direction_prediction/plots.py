...
def main():
    ...
    plot(proposed[1], baseline[1], len(baseline[0]), '$\sigma(\gamma)$', "results/direction_gamma_N=10.pdf", [0, 0.5, 1])
    plot(proposed[2] * 100, baseline[2] * 100, 50, 'Accuracy (%)', "results/direction_acc_N=10.pdf", [0, 50, 100])
